 ...
 * start and stop flag is set in CR1 at the same time. So i tried setting the
 * CR1 at once with I2C_SENSORS->CR1 = (I2C_CR1_START | I2C_CR1_ACK |
 * I2C_CR1_PE) and the problem is gone. Go figure...
 */
...
// Definition of eeprom and deck I2C buss,use two i2c with 400Khz clock
// simultaneously could trigger the watchdog
