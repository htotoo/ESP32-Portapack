...
void init_environment()
{
    ...
    bmp280_init_desc(&dev_bmp280, getDevAddr(BMx280), 0, CONFIG_IC2SDAPIN, CONFIG_IC2SCLPIN);
...
void init_environment_light()
{
    ...
    bh1750_init_desc(&bh1750, getDevAddr(BH1750), 0, CONFIG_IC2SDAPIN, CONFIG_IC2SCLPIN);
